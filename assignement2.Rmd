...
Green vline------------iris_subset_2 data median(0.08)
...
p_2<-ggplot2::ggplot(ptest_d_2, ggplot2::aes_string(x="permuted",y="(..count..)"))+ggplot2::geom_histogram(fill="yellow",colour="black")+ggplot2::geom_vline(ggplot2::aes(xintercept=median(ptest_new$observed)),color="green",size=2)+ggplot2::geom_vline(xintercept=difference_in_medians(iris, "Sepal.Width", "Species", "versicolor", "virginica"),color = "blue",size=2)+ggplot2::geom_vline(xintercept=median_sub_1,color="red",size=2)
...
p_1<-ggplot2::ggplot(ptest_d_1, ggplot2::aes_string(x="permuted",y="(..count..)"))+ggplot2::geom_histogram(fill="yellow",colour="black")+ggplot2::geom_vline(ggplot2::aes(xintercept=median(ptest_new$observed)),color="red",size=2)+ggplot2::geom_vline(xintercept=difference_in_medians(iris, "Sepal.Width", "Species", "versicolor", "virginica"),color = "blue",size=2)+ggplot2::geom_vline(xintercept=median_sub_2,color="green",size=2)
